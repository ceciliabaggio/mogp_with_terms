...
def plot_avgAvgAvgPrecision_at_10(directory, combination):
    ...
    plt.ylabel(r'$$\overline{\overline{\textit{Precisi\'on@10-Entr\'opica}}}$$', fontsize=14)
...
if len(sys.argv) == 9:
    ...
    plt.savefig(save_dir + "evolution_entropicPrecision-terms.pdf", bbox_extra_artists=(lgd,), bbox_inches='tight')
    #plt.show()
