...
def plot_avgAvgAvgPrecision_at_10(directory, combination):
    ...
    for topic in topic_folders:
        ...
        file_all_run = fnmatch.filter(subfolder, '*_entropicPrecision_all_run.txt')[0]
        print (file_all_run)
    ...
    plt.ylabel(r'$$\overline{\overline{\textit{Entropic-Precision@10}}}$$', fontsize=20)
...
if len(sys.argv) == 9:
    ...
    #plt.savefig(save_dir + "evolution_entropicPrecision.pdf")
    #plt.savefig(save_dir + "evolution_entropicPrecision-terms.svg", bbox_extra_artists=(lgd,), bbox_inches='tight')
    plt.savefig(save_dir + "evolution_entropicPrecision-concepts.svg", bbox_extra_artists=(lgd,), bbox_inches='tight')
    #plt.show()
