...
def plot_avgAvgAvgPrecision_at_10(directory, combination):
    ...
    plt.ylabel(r'$$\overline{\overline{\textit{Recall}}}$$', fontsize=14)
...
if len(sys.argv) == 9:
    ...
    #plt.savefig(save_dir + "evolution_Recall.pdf")
    plt.savefig(save_dir + "evolution_Recall-terms.pdf" , bbox_extra_artists=(lgd,), bbox_inches='tight')
    #plt.show()
