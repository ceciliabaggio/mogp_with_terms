...
def plot_avgAvgGlobalRecall(directory, combination):
    ...
    for topic in topic_folders:
        ...
        file_all_run = fnmatch.filter(subfolder, '*_globalRecall_all_run.txt')[0]
        print file_all_run
...
if len(sys.argv) == 9:
    ...
    plt.savefig(save_dir + "evolution_globalRecall-terms.pdf" , bbox_extra_artists=(lgd,), bbox_inches='tight')    
    #plt.show()
                  
else:
    print "debe ingresar los directorios de donde leer y el dir donde GUARDAR FIGURAS"
    print " "
    print "Ejemplo: python plot_avgAvgGlobalRecall_Co1_Co2_Co3_Co4_Co5_Co6 \
